  ...
  return (
    <Stack>
      <Alert color="blue" title="후보 확정 결과 (1단계)">
        ...
        않습니다.</b> 확정된 매출액·총자산은 재무정보 수집(2단계)에서 감사보고서
        원문을 파싱한 뒤에 채워지며, <b>결과 화면에서 그 실제 파싱값으로 직접 걸러
        볼 수 있습니다.</b> 재무 13항목과 파싱 상태도 그때 채워집니다.
      </Alert>
        ...
        <Group justify="space-between" align="flex-end" wrap="wrap">
          <div>
            ...
            <Text size="sm" c="dimmed" mb="xs">
              ...
              한도를 넘으면 자동으로 멈췄다가 다음 날 이어서 진행됩니다 — 중간에 멈춰도 그때까지
              수집된 회사의 결과는 그대로 남고, 매출액·총자산은 결과 화면에서 실제 파싱값 기준으로
              직접 좁혀 볼 수 있습니다. 시작 후 작업 목록 화면에서 진행률을 확인하세요. 아래 표에서 "삭제"
